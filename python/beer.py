...
class Beer:
    ...
    def __repr__(self):
        return f"Beer(title='{self.title}', production_date='{self.production_date.strftime('%Y-%m-%d') if isinstance(self.production_date, datetime) else self.production_date}')"
